...
public:
    ...
    void update_ANN() {
        ...
        vision_neurons[0] = CalculateVision(1., 15., M_PI_4/4.0, btVector3 (0.0, 1.0, 0.2), 2.1, 7.8);
        vision_neurons[1] = CalculateVision(1., 15., M_PI_4/4.0, btVector3 (0.0, 1.0, 0.2), 2.4, 7.8);
        vision_neurons[2] = CalculateVision(1., 15., M_PI_4/4.0, btVector3 (0.0, 1.0, 0.2), 2.7, 7.8);
        vision_neurons[3] = CalculateVision(1., 15., M_PI_4/4.0, btVector3 (0.0, 1.0, 0.2), 3.0, 7.8);
        vision_neurons[4] = CalculateVision(1., 15., M_PI_4/4.0, btVector3 (0.0, 1.0, 0.2), 3.3, 7.8);
        vision_neurons[5] = CalculateVision(1., 15., M_PI_4/4.0, btVector3 (0.0, 1.0, 0.2), 3.6, 7.8);
        vision_neurons[6] = CalculateVision(1., 15., M_PI_4/4.0, btVector3 (0.0, 1.0, 0.2), 3.9, 7.8);

        for (int i = 0; i<7; i++){
            //vision_neurons[i] = CalculateVision(10., 15., M_PI_4/4.0, btVector3 (0.0, 1.0, 0.2), 3.3, 7.8);
            //draw_line(btVector3(1., 1., 0.), btVector3 (10., 0., 10.), btVector3 (0.3, 0.3, 0.3));
            //draw_line(btVector3(1., 1., 0.), btVector3 (-10., 0., 10.), btVector3 (0.3, 0.3, 0.3));
            //draw_line(btVector3(1., 1., 0.), btVector3 (-2.5, 0., 10.), btVector3 (0.3, 0.3, 0.3));
            //draw_line(btVector3(1., 1., 0.), btVector3 ( 2.5, 0., 10.), btVector3 (0.3, 0.3, 0.3));
            printf("%f", vision_neurons[i]);
         }
        ...
        for (int h=0; h<4; h++) {
            ...
            for (int p=0; p<4; p++){
                hidden_Neurons[h] = hidden_Neurons[h] + weights[h][p] * Prop[p] + vision_neurons[p] * weights[h][p+16];
            }
        ...
        for (int h=0; h<4; h++) {
            ...
            for (int p=0; p<7; p++){
                hidden_Neurons[h] = hidden_Neurons[h] + vision_neurons[p] * weights[h][p+16];
            }
            hidden_Neurons[h] = tanh(hidden_Neurons[h]);
        }
        ...
        for (int h=0; h<4; h++){
            for (int p=0; p<4; p++) {
                motor_neurons[h] = motor_neurons[h] + (hidden_Neurons[h] * weights[h][4+p]);
            }
