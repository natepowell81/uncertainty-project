...
def run_training_CR(population, num_timesteps, training_list):
                    ...
                    if "gmvector.txt" == thisFile:
                        ...
                        for line in result:
                            for i in range(len(line)):
                                gvarvectlist.append(line[0])
                                movelist.append(line[1])
                                individual.fit2.append(gvarvectlist)
                        gmlist.remove(thisIdentifier)
                        
                    if "gerrorvector.txt" == thisFile:
                        gmeanvectlist = []
                        for line in result:
                            gmeanvectlist.append(line)
                            individual.fit2.append(gmeanvectlist)
    ...
    if not done:
        ...
        for individual in population:
            individual.fit = sum(individual.fit1)/7.0 * sum(individual.fit3)/7.0
