...
def run_testing_CM(test_list, population, timestep):
    ...
    newpath = r'/Users/np/Desktop/Bullet/bullet_make/Demos/RagdollDemo/Debug/Images/CM/Individuals_'+datetime.datetime.strftime(datetime.datetime.now(), '%Y-%m-%d')
    if not os.path.exists(newpath):
        os.makedirs(newpath)
        
    newpath = r'/Users/np/Desktop/Bullet/bullet_make/Demos/RagdollDemo/Debug/Images/CM/Individuals_'+datetime.datetime.strftime(datetime.datetime.now(), '%Y-%m-%d')+'/Individuals'+str(individual.uid)+'_data_for_neurons'
    if not os.path.exists(newpath):
        os.makedirs(newpath)
...
def secondary_CM(newpopulation, POP_SIZE, num_timesteps, training_list):
    newpopulation = run_training_second_CM(newpopulation, POP_SIZE, num_timesteps, training_list)
...
if __name__ == "__main__":
    population_dict = {}
    for i in range(0,1):
        newpop = iterations_CM(50, POP_SIZE, num_timesteps)
