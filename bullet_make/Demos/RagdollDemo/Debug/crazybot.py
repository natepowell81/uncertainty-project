...
def runner(i):
    ...
    if i == 0:
        position_size = [0.0, 0.0, 6.2, 1.0, 1.0, -0.5]            #Center robot should be blind to this
        Send_Values_ToFile_two(position_size, "position_size.csv")
        os.system('./AppRagdollDemo')
        #print position_size
    if i == 1:
        position_size = [0.0, 0.0, 6.2, 1.5, 1.5, 0.5]
        Send_Values_ToFile_two(position_size, "position_size.csv")
        os.system('./AppRagdollDemo')
        #print position_size
        
    if i == 2:                                              #first to the right  should be visible
        position_size = [1.5, 0.0, 5.5, 1.0, 1.0, -0.5]
        Send_Values_ToFile_two(position_size, "position_size.csv")
        os.system('./AppRagdollDemo')
        #print position_size
    if i == 3:
        position_size = [1.5, 0.0, 5.5, 1.5, 1.5, 0.5]
        Send_Values_ToFile_two(position_size, "position_size.csv")
        os.system('./AppRagdollDemo')
        #print position_size
        
    if i == 4:                                             #should be blind to this
        position_size = [3.5, 0.0, 5.5, 1.5, 1.5, 0.5]
        Send_Values_ToFile_two(position_size, "position_size.csv")
        os.system('./AppRagdollDemo')
        #print position_size
    if i == 5:
        position_size = [3.5, 0.0, 5.5, 1.0, 1.0, -0.5]
        Send_Values_ToFile_two(position_size, "position_size.csv")
        os.system('./AppRagdollDemo')
        #print position_size
        
    
    if i == 6:                                           #should be visible
        position_size = [5.7, 0.0, 4.2, 1.5, 1.5, 0.5]
        Send_Values_ToFile_two(position_size, "position_size.csv")
        os.system('./AppRagdollDemo')
        #print position_size
    if i == 7:
        position_size = [5.7, 0.0, 4.2, 1.0, 1.0, -0.5]
        Send_Values_ToFile_two(position_size, "position_size.csv")
        os.system('./AppRagdollDemo')
        #print position_size
    
    if i == 8:                                         #should be blind
        position_size = [-1.5, 0.0, 5.0, 1.5, 1.5, 0.5]
        Send_Values_ToFile_two(position_size, "position_size.csv")
        os.system('./AppRagdollDemo')
        #print position_size
    if i == 9:
        position_size = [-1.5, 0.0, 5.0, 1.0, 1.0, -0.5]
        Send_Values_ToFile_two(position_size, "position_size.csv")
        os.system('./AppRagdollDemo')
        #print position_size
    
    if i == 10:                                        #should be visible
        position_size = [-3.5, 0.0, 5.0, 1.5, 1.5, 0.5]
        Send_Values_ToFile_two(position_size, "position_size.csv")
        os.system('./AppRagdollDemo')
        #print position_size
    if i == 11:
        position_size = [-3.5, 0.0, 5.0, 1.0, 1.0, -0.5]
        Send_Values_ToFile_two(position_size, "position_size.csv")
        os.system('./AppRagdollDemo')
        #print position_size
    
    if i == 12:                                        #should be blind
        position_size = [-5.7, 0.0, 4.2, 1.5, 1.5, 0.5]
        Send_Values_ToFile_two(position_size, "position_size.csv")
        os.system('./AppRagdollDemo')
        #print position_size
...
def initial_spaz(POP_SIZE, num_timesteps):
    oldpopulation = [Individual() for i in range(0, POP_SIZE)]
    oldpopulation = run_spaz(oldpopulation, num_timesteps)
    newpopulation = dominate_spaz(oldpopulation)
    return newpopulation
    
def secondary_spaz(newpopulation, POP_SIZE, num_timesteps):
    newpopulation = run_second_spaz(newpopulation, POP_SIZE, num_timesteps)
...
def iterations_spaz(generations, POP_SIZE, num_timesteps):
    for i in range(0, generations):
        print "Gen =", i
        if i == 0:
            newpopulation = initial_spaz(POP_SIZE, num_timesteps)
            newpopulation = AGE_individuals_spaz(newpopulation)
            newpopulation2 = newpopulation  
        if i > 0:
            newpopulation = secondary_spaz(newpopulation, POP_SIZE, num_timesteps)
            newpopulation = AGE_individuals_spaz(newpopulation)  
...
if __name__ == "__main__":
    ...
    newpop = iterations_spaz(1, POP_SIZE, num_timesteps)
